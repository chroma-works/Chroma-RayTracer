...
namespace CHR
{
	...
	void Shader::AddLight(std::shared_ptr<DirectionalLight> lig)
	{
		if (num_dir_lights < MAX_NUM_LIGHTS)
		{
			...
			direction.data = (void*)&lig->m_direction;
