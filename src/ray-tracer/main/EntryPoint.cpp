...
int main()
{
	...
	Chroma::Settings s;
	scene = std::make_shared<Chroma::Scene>(*(Chroma::AssetImporter::LoadSceneFromXML(shader, "../../assets/scenes/hw4/sphere_nearest_bilinear.xml", &s)));
	//init editor
