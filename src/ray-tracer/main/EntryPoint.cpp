...
int main()
{
	...
	scene = std::make_shared<CHR::Scene>(*(CHR::AssetImporter::LoadSceneFromXML(shader, "../../assets/scenes/hw7/directLighting/cornellbox_jaroslav_glossy_area_sphere.xml")));
	//init editor
